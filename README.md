...
---
### 💡 About Me
Hi, I'm **Andrew**, a backend developer from Egypt 🇪🇬.  
build scalable and secure backend systems with **C++**, **.NET**, and **SQL**, focusing on **performance**, **security**, and **real-world solutions**.  
...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:ebrahemandroe83@gmail.com) 
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Androibrahim?tab=repositories)
[![Codewars](https://img.shields.io/badge/Codewars-B1361E?style=for-the-badge&logo=codewars&logoColor=white)](https://www.codewars.com/users/DROO%20;)

---

### 🎓 Education
**Bachelor of Computer Science** – Nahda University (2021 – 2025)  
GPA: 3.4 / 4.0 • Relevant Coursework: Algorithms, Data Structures, Database Management, OOP, Web Development
...
<div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
  <div style="flex: 1; min-width: 250px; border: 1px solid #ddd; padding: 10px; border-radius: 8px; text-align: center;">
    <strong>NTI: HCIA Cloud Computing | </strong>
    <small>70h (Oct 2025 – Dec 2025)</small>
    <p style="margin: 5px 0;">🟢 Networking • 🟢 OS • 🟢 Virtualization • 🟢 Huawei FusionSphere</p>
  </div>

  <div style="flex: 1; min-width: 250px; border: 1px solid #ddd; padding: 10px; border-radius: 8px; text-align: center;">
    <strong>DEPI: Full Stack .NET Developer</strong><br>
    <small>Nov 2024 – May 2025</small>
    <p style="margin: 5px 0;">🔵 C# • 🔵 OOP • 🔵 LINQ • 🔵 EF Core • 🔵 SQL Server • 🔵 .NET Core Web API • 🔵 ASP.NET Core MVC • 🔵 Git & GitHub</p>
  </div>

  <div style="flex: 1; min-width: 250px; border: 1px solid #ddd; padding: 10px; border-radius: 8px; text-align: center;">
    <strong>ITI: Web Fundamentals</strong><br>
    <small>66h (Aug 2024)</small>
    <p style="margin: 5px 0;">🟠 HTML5 • 🟠 CSS3 • 🟠 JavaScript • 🟠 Bootstrap • 🟠 Firebase</p>
  </div>

  <div style="flex: 1; min-width: 250px; border: 1px solid #ddd; padding: 10px; border-radius: 8px; text-align: center;">
    <strong>ITI: .NET Full Stack</strong><br>
    <small>72h (July 2024)</small>
    <p style="margin: 5px 0;">🟣 C# • 🟣 OOP • 🟣 SQL Server • 🟣 ASP.NET MVC</p>
  </div>
</div>
-->
